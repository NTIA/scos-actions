...
class TransmitCW(Action):
    ...
    :param cw_frequency: frequency of the tone to be transmitted
    ...
    def description(self):
        defs = {
            ...
            "cw_frequency": self.measurement_params.cw_frequency,
