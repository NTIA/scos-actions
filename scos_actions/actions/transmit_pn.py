...
class TransmitPN(Action):
    ...
    def __init__(self, name, frequency, gain, sample_rate, duration_ms, seed, sampspersymbol, radio):
    ...
    def call_transmit_pn(self):
        ...
        data = self.radio.transmit_pn(self.measurement_params.seed, self.measurement_params.sampspersymbol, self.measurement_params.duration_ms)
